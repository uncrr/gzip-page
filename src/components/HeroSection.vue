      ...
      <div class="hero-content">
        <div class="hero-text">
          ...
          <div class="platform-badges">
            ...
            <div class="platform-badge">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17.523 15.3414c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.5511 0 .9993.4482.9993.9993.0001.5511-.4482.9997-.9993.9997m-11.046 0c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.5511 0 .9993.4482.9993.9993 0 .5511-.4482.9997-.9993.9997m11.4045-6.02l1.9973-3.4592a.416.416 0 00-.7514-.3676l-2.2646 3.9262c-1.43-.8094-3.0259-1.2678-4.6259-1.2678-1.6 0-3.1959.4584-4.6259 1.2678L5.3856 5.4594a.4161.4161 0 00-.7514.3676l1.9973 3.4592C2.6503 11.7906.8429 15.8335.8429 20.5421c0 .5519.4476.9993.9993.9993h19.317c.5517 0 .9993-.4474.9993-.9993-.0001-4.7086-1.8075-8.7515-5.7888-11.2207"/>
              </svg>
              <span>Android</span>
            </div>
          ...
          <div class="hero-actions">
            ...
            <a href="https://github.com/uncrr/gzip-explorer" target="_blank" class="btn btn-secondary">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <!-- <div class="hero-image">
          <img src="/images/app-preview.png" alt="Gzip Explorer Preview" />
        </div> -->
      </div>
    </div>
  </section>
